...
function checkWinClass (play) {
  ...
  if (($('.r1c1').text() === play) && ($('.r1c2').text() === play) && ($('.r1c3').text() === play)) {
     ...
     $('.winner').text($('.r1c1').text() + ' has won the game!');
     return;
  }
